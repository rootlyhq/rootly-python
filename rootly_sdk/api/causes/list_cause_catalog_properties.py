...
def _get_kwargs(
    *,
    include: ListCauseCatalogPropertiesInclude | Unset = UNSET,
    sort: ListCauseCatalogPropertiesSort | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        include (ListCauseCatalogPropertiesInclude | Unset):
        sort (ListCauseCatalogPropertiesSort | Unset):
