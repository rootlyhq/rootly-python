...
from ...models.list_group_catalog_properties_include import (
    ListGroupCatalogPropertiesInclude,
)
from ...models.list_group_catalog_properties_sort import (
    ListGroupCatalogPropertiesSort,
)
...
def _get_kwargs(
    *,
    include: ListGroupCatalogPropertiesInclude | Unset = UNSET,
    sort: ListGroupCatalogPropertiesSort | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        include (ListGroupCatalogPropertiesInclude | Unset):
        sort (ListGroupCatalogPropertiesSort | Unset):
