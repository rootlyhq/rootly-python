...
def _get_kwargs(
    *,
    include: ListEnvironmentCatalogPropertiesInclude | Unset = UNSET,
    sort: ListEnvironmentCatalogPropertiesSort | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/environments/properties",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        include (ListEnvironmentCatalogPropertiesInclude | Unset):
        sort (ListEnvironmentCatalogPropertiesSort | Unset):
