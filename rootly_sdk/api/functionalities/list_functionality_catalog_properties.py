...
from ...models.list_functionality_catalog_properties_include import (
    ListFunctionalityCatalogPropertiesInclude,
)
from ...models.list_functionality_catalog_properties_sort import (
    ListFunctionalityCatalogPropertiesSort,
)
...
def _get_kwargs(
    *,
    include: ListFunctionalityCatalogPropertiesInclude | Unset = UNSET,
    sort: ListFunctionalityCatalogPropertiesSort | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/functionalities/properties",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        include (ListFunctionalityCatalogPropertiesInclude | Unset):
        sort (ListFunctionalityCatalogPropertiesSort | Unset):
