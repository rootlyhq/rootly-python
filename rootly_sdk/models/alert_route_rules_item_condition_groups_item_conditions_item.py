...
class AlertRouteRulesItemConditionGroupsItemConditionsItem:
    ...
    Attributes:
        ...
        conditionable_type (AlertRouteRulesItemConditionGroupsItemConditionsItemConditionableType | Unset): The type of
            the conditionable
    ...
    conditionable_type: AlertRouteRulesItemConditionGroupsItemConditionsItemConditionableType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conditionable_type: AlertRouteRulesItemConditionGroupsItemConditionsItemConditionableType | Unset
