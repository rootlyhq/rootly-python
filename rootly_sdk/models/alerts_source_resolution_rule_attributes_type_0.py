...
class AlertsSourceResolutionRuleAttributesType0:
    ...
    Attributes:
        ...
        condition_type (AlertsSourceResolutionRuleAttributesType0ConditionType | Unset): The type of condition to
            evaluate to apply auto resolution rule
        identifier_matchable_type (AlertsSourceResolutionRuleAttributesType0IdentifierMatchableType | Unset): The type
            of the identifier matchable
        ...
        identifier_reference_kind (AlertsSourceResolutionRuleAttributesType0IdentifierReferenceKind | Unset): The kind
        ...
        identifier_value_regex (None | str | Unset): Regex group to further specify the part of the string used as a
            unique identifier
        conditions_attributes (list[AlertsSourceResolutionRuleAttributesType0ConditionsAttributesItem] | Unset): List of
            conditions to evaluate for auto resolution
    """

    enabled: bool | Unset = UNSET
    condition_type: AlertsSourceResolutionRuleAttributesType0ConditionType | Unset = UNSET
    identifier_matchable_type: AlertsSourceResolutionRuleAttributesType0IdentifierMatchableType | Unset = UNSET
    identifier_matchable_id: None | str | Unset = UNSET
    identifier_reference_kind: AlertsSourceResolutionRuleAttributesType0IdentifierReferenceKind | Unset = UNSET
    identifier_json_path: None | str | Unset = UNSET
    identifier_value_regex: None | str | Unset = UNSET
    conditions_attributes: list[AlertsSourceResolutionRuleAttributesType0ConditionsAttributesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        condition_type: AlertsSourceResolutionRuleAttributesType0ConditionType | Unset
        ...
        identifier_matchable_type: AlertsSourceResolutionRuleAttributesType0IdentifierMatchableType | Unset
        ...
        identifier_reference_kind: AlertsSourceResolutionRuleAttributesType0IdentifierReferenceKind | Unset
        ...
        if _conditions_attributes is not UNSET:
            ...
            for conditions_attributes_item_data in _conditions_attributes:
                conditions_attributes_item = (
                    AlertsSourceResolutionRuleAttributesType0ConditionsAttributesItem.from_dict(
