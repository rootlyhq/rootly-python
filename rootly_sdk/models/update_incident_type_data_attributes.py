...
class UpdateIncidentTypeDataAttributes:
    ...
    slack_channels: None | Unset | list["UpdateIncidentTypeDataAttributesSlackChannelsType0Item"] = UNSET
    slack_aliases: None | Unset | list["UpdateIncidentTypeDataAttributesSlackAliasesType0Item"] = UNSET
    fields: Unset | list["UpdateIncidentTypeDataAttributesFieldsItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_slack_channels(
            data: object,
        ) -> None | Unset | list["UpdateIncidentTypeDataAttributesSlackChannelsType0Item"]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(None | Unset | list["UpdateIncidentTypeDataAttributesSlackChannelsType0Item"], data)

        slack_channels = _parse_slack_channels(d.pop("slack_channels", UNSET))

        def _parse_slack_aliases(
            data: object,
        ) -> None | Unset | list["UpdateIncidentTypeDataAttributesSlackAliasesType0Item"]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(None | Unset | list["UpdateIncidentTypeDataAttributesSlackAliasesType0Item"], data)
