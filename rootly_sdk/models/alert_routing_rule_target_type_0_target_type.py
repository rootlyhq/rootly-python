...
AlertRoutingRuleTargetType0TargetType = Literal["EscalationPolicy", "Functionality", "Group", "Service"]
...
def check_alert_routing_rule_target_type_0_target_type(
    value: str | None,
) -> AlertRoutingRuleTargetType0TargetType | None:
    if value is None:
        return None
