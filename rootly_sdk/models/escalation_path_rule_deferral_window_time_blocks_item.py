...
T = TypeVar("T", bound="EscalationPathRuleDeferralWindowTimeBlocksItem")


@_attrs_define
class EscalationPathRuleDeferralWindowTimeBlocksItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        escalation_path_rule_deferral_window_time_blocks_item = cls(
            monday=monday,
            tuesday=tuesday,
            wednesday=wednesday,
            thursday=thursday,
        ...
        escalation_path_rule_deferral_window_time_blocks_item.additional_properties = d
        return escalation_path_rule_deferral_window_time_blocks_item
