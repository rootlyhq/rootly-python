...
class NewStatusPageDataAttributes:
    ...
    Attributes:
        ...
        show_uptime_last_days (NewStatusPageDataAttributesShowUptimeLastDays | Unset): Show uptime over x days
        ...
        authentication_method (NewStatusPageDataAttributesAuthenticationMethod | Unset): Authentication method Default:
            'none'.
        ...
        saml_name_identifier_format (NewStatusPageDataAttributesSamlNameIdentifierFormat | Unset): SAML name identifier
            format
        section_order (list[NewStatusPageDataAttributesSectionOrderType0Item] | None | Unset): Order of sections on the
            status page
    ...
    show_uptime_last_days: NewStatusPageDataAttributesShowUptimeLastDays | Unset = UNSET
    success_message: None | str | Unset = UNSET
    failure_message: None | str | Unset = UNSET
    authentication_method: NewStatusPageDataAttributesAuthenticationMethod | Unset = "none"
    ...
    saml_name_identifier_format: NewStatusPageDataAttributesSamlNameIdentifierFormat | Unset = UNSET
    section_order: list[NewStatusPageDataAttributesSectionOrderType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        show_uptime_last_days: NewStatusPageDataAttributesShowUptimeLastDays | Unset
        ...
        authentication_method: NewStatusPageDataAttributesAuthenticationMethod | Unset
        ...
        saml_name_identifier_format: NewStatusPageDataAttributesSamlNameIdentifierFormat | Unset
        ...
        def _parse_section_order(data: object) -> list[NewStatusPageDataAttributesSectionOrderType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(list[NewStatusPageDataAttributesSectionOrderType0Item] | None | Unset, data)
