...
T = TypeVar("T", bound="UpdateTeamDataAttributesPropertiesItem")


@_attrs_define
class UpdateTeamDataAttributesPropertiesItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_team_data_attributes_properties_item = cls(
            catalog_property_id=catalog_property_id,
            value=value,
        )

        update_team_data_attributes_properties_item.additional_properties = d
