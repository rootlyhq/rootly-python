...
class RunCommandHerokuTaskParams:
    ...
    Attributes:
        ...
        task_type (RunCommandHerokuTaskParamsTaskType | Unset):
        post_to_incident_timeline (bool | Unset):
        post_to_slack_channels (list[RunCommandHerokuTaskParamsPostToSlackChannelsItem] | Unset):
    """

    command: str
    app_name: str
    size: RunCommandHerokuTaskParamsSize
    task_type: RunCommandHerokuTaskParamsTaskType | Unset = UNSET
    post_to_incident_timeline: bool | Unset = UNSET
    post_to_slack_channels: list[RunCommandHerokuTaskParamsPostToSlackChannelsItem] | Unset = UNSET
