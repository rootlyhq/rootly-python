...
T = TypeVar("T", bound="ServicePropertiesType0Item")


@_attrs_define
class ServicePropertiesType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_properties_type_0_item = cls(
            catalog_property_id=catalog_property_id,
            value=value,
        )

        service_properties_type_0_item.additional_properties = d
        return service_properties_type_0_item
