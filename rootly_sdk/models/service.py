...
class Service:
    ...
    slack_channels: None | Unset | list["ServiceSlackChannelsType0Item"] = UNSET
    slack_aliases: None | Unset | list["ServiceSlackAliasesType0Item"] = UNSET
    ...
    fields: None | Unset | list["ServiceFieldsType0Item"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_slack_channels(data: object) -> None | Unset | list["ServiceSlackChannelsType0Item"]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(None | Unset | list["ServiceSlackChannelsType0Item"], data)
        ...
        def _parse_slack_aliases(data: object) -> None | Unset | list["ServiceSlackAliasesType0Item"]:
            ...
            try:
                ...
                pass
            return cast(None | Unset | list["ServiceSlackAliasesType0Item"], data)
        ...
        def _parse_fields(data: object) -> None | Unset | list["ServiceFieldsType0Item"]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(None | Unset | list["ServiceFieldsType0Item"], data)
