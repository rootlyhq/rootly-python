...
class AlertGroupConditionsItem:
    ...
    Attributes:
        ...
        property_field_condition_type (AlertGroupConditionsItemPropertyFieldConditionType): The condition type of the
            property field
        property_field_name (None | str | Unset): The name of the property field. If the property field type is selected
        ...
        values (list[AlertGroupConditionsItemValuesItemType0 | None] | Unset):
        ...
        conditionable_type (AlertGroupConditionsItemConditionableType | Unset): The type of the conditionable
    ...
    property_field_name: None | str | Unset = UNSET
    property_field_value: None | str | Unset = UNSET
    property_field_values: list[str] | Unset = UNSET
    values: list[AlertGroupConditionsItemValuesItemType0 | None] | Unset = UNSET
    alert_urgency_ids: list[str] | None | Unset = UNSET
    conditionable_type: AlertGroupConditionsItemConditionableType | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        property_field_name: None | str | Unset
        ...
        values: list[dict[str, Any] | None] | Unset = UNSET
        if not isinstance(self.values, Unset):
            values = []
            for values_item_data in self.values:
                values_item: dict[str, Any] | None
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_property_field_name(data: object) -> None | str | Unset:
            if data is None:
                return data
        ...
        if _values is not UNSET:
            ...
            for values_item_data in _values:
                ...
                def _parse_values_item(data: object) -> AlertGroupConditionsItemValuesItemType0 | None:
                    if data is None:
                        return data
                    try:
                        ...
                        pass
                    return cast(AlertGroupConditionsItemValuesItemType0 | None, data)
        ...
        conditionable_type: AlertGroupConditionsItemConditionableType | Unset
