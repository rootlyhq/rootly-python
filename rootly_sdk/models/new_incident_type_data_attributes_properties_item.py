...
@_attrs_define
class NewIncidentTypeDataAttributesPropertiesItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        new_incident_type_data_attributes_properties_item = cls(
            catalog_property_id=catalog_property_id,
            value=value,
        )

        new_incident_type_data_attributes_properties_item.additional_properties = d
        return new_incident_type_data_attributes_properties_item
