...
class UpdateAlertsSourceDataAttributesResolutionRuleAttributesType0:
    ...
    Attributes:
        ...
        condition_type (UpdateAlertsSourceDataAttributesResolutionRuleAttributesType0ConditionType | Unset): The type of
            condition to evaluate to apply auto resolution rule
        identifier_matchable_type (UpdateAlertsSourceDataAttributesResolutionRuleAttributesType0IdentifierMatchableType
        ...
        identifier_reference_kind (UpdateAlertsSourceDataAttributesResolutionRuleAttributesType0IdentifierReferenceKind
        ...
        conditions_attributes
            (list[UpdateAlertsSourceDataAttributesResolutionRuleAttributesType0ConditionsAttributesItem] | Unset): List of
            conditions to evaluate for auto resolution
    """

    enabled: bool | Unset = UNSET
    condition_type: UpdateAlertsSourceDataAttributesResolutionRuleAttributesType0ConditionType | Unset = UNSET
    identifier_matchable_type: (
        UpdateAlertsSourceDataAttributesResolutionRuleAttributesType0IdentifierMatchableType | Unset
    ) = UNSET
    identifier_matchable_id: None | str | Unset = UNSET
    identifier_reference_kind: (
        UpdateAlertsSourceDataAttributesResolutionRuleAttributesType0IdentifierReferenceKind | Unset
    ) = UNSET
    identifier_json_path: None | str | Unset = UNSET
    identifier_value_regex: None | str | Unset = UNSET
    conditions_attributes: (
        list[UpdateAlertsSourceDataAttributesResolutionRuleAttributesType0ConditionsAttributesItem] | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        condition_type: UpdateAlertsSourceDataAttributesResolutionRuleAttributesType0ConditionType | Unset
