...
class UpdateStatusPageDataAttributes:
    ...
    show_uptime_last_days: Unset | UpdateStatusPageDataAttributesShowUptimeLastDays = UNSET
    success_message: None | Unset | str = UNSET
    failure_message: None | Unset | str = UNSET
    authentication_method: Unset | UpdateStatusPageDataAttributesAuthenticationMethod = "none"
    ...
    saml_name_identifier_format: Unset | UpdateStatusPageDataAttributesSamlNameIdentifierFormat = UNSET
