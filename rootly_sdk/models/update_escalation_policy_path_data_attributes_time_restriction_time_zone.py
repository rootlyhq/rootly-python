...
UPDATE_ESCALATION_POLICY_PATH_DATA_ATTRIBUTES_TIME_RESTRICTION_TIME_ZONE_VALUES: set[
...
def check_update_escalation_policy_path_data_attributes_time_restriction_time_zone(
    value: str | None,
) -> UpdateEscalationPolicyPathDataAttributesTimeRestrictionTimeZone | None:
    if value is None:
        return None
