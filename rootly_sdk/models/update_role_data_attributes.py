...
class UpdateRoleDataAttributes:
    ...
    Attributes:
        ...
        api_keys_permissions (list[UpdateRoleDataAttributesApiKeysPermissionsItem] | Unset):
        audits_permissions (list[UpdateRoleDataAttributesAuditsPermissionsItem] | Unset):
        billing_permissions (list[UpdateRoleDataAttributesBillingPermissionsItem] | Unset):
        environments_permissions (list[UpdateRoleDataAttributesEnvironmentsPermissionsItem] | Unset):
        form_fields_permissions (list[UpdateRoleDataAttributesFormFieldsPermissionsItem] | Unset):
        functionalities_permissions (list[UpdateRoleDataAttributesFunctionalitiesPermissionsItem] | Unset):
        groups_permissions (list[UpdateRoleDataAttributesGroupsPermissionsItem] | Unset):
        incident_causes_permissions (list[UpdateRoleDataAttributesIncidentCausesPermissionsItem] | Unset):
        incident_feedbacks_permissions (list[UpdateRoleDataAttributesIncidentFeedbacksPermissionsItem] | Unset):
        incident_roles_permissions (list[UpdateRoleDataAttributesIncidentRolesPermissionsItem] | Unset):
        incident_types_permissions (list[UpdateRoleDataAttributesIncidentTypesPermissionsItem] | Unset):
        incidents_permissions (list[UpdateRoleDataAttributesIncidentsPermissionsItem] | Unset):
        integrations_permissions (list[UpdateRoleDataAttributesIntegrationsPermissionsItem] | Unset):
        invitations_permissions (list[UpdateRoleDataAttributesInvitationsPermissionsItem] | Unset):
        playbooks_permissions (list[UpdateRoleDataAttributesPlaybooksPermissionsItem] | Unset):
        private_incidents_permissions (list[UpdateRoleDataAttributesPrivateIncidentsPermissionsItem] | Unset):
        retrospective_permissions (list[UpdateRoleDataAttributesRetrospectivePermissionsItem] | Unset):
        roles_permissions (list[UpdateRoleDataAttributesRolesPermissionsItem] | Unset):
        secrets_permissions (list[UpdateRoleDataAttributesSecretsPermissionsItem] | Unset):
        services_permissions (list[UpdateRoleDataAttributesServicesPermissionsItem] | Unset):
        severities_permissions (list[UpdateRoleDataAttributesSeveritiesPermissionsItem] | Unset):
        status_pages_permissions (list[UpdateRoleDataAttributesStatusPagesPermissionsItem] | Unset):
        webhooks_permissions (list[UpdateRoleDataAttributesWebhooksPermissionsItem] | Unset):
        workflows_permissions (list[UpdateRoleDataAttributesWorkflowsPermissionsItem] | Unset):
        catalogs_permissions (list[UpdateRoleDataAttributesCatalogsPermissionsItem] | Unset):
        sub_statuses_permissions (list[UpdateRoleDataAttributesSubStatusesPermissionsItem] | Unset):
        edge_connector_permissions (list[UpdateRoleDataAttributesEdgeConnectorPermissionsItem] | Unset):
        slas_permissions (list[UpdateRoleDataAttributesSlasPermissionsItem] | Unset):
        paging_permissions (list[UpdateRoleDataAttributesPagingPermissionsItem] | Unset):
        incident_communication_permissions (list[UpdateRoleDataAttributesIncidentCommunicationPermissionsItem] | Unset):
        communication_permissions (list[UpdateRoleDataAttributesCommunicationPermissionsItem] | Unset):
    """
    ...
    api_keys_permissions: list[UpdateRoleDataAttributesApiKeysPermissionsItem] | Unset = UNSET
    audits_permissions: list[UpdateRoleDataAttributesAuditsPermissionsItem] | Unset = UNSET
    billing_permissions: list[UpdateRoleDataAttributesBillingPermissionsItem] | Unset = UNSET
    environments_permissions: list[UpdateRoleDataAttributesEnvironmentsPermissionsItem] | Unset = UNSET
    form_fields_permissions: list[UpdateRoleDataAttributesFormFieldsPermissionsItem] | Unset = UNSET
    functionalities_permissions: list[UpdateRoleDataAttributesFunctionalitiesPermissionsItem] | Unset = UNSET
    groups_permissions: list[UpdateRoleDataAttributesGroupsPermissionsItem] | Unset = UNSET
    incident_causes_permissions: list[UpdateRoleDataAttributesIncidentCausesPermissionsItem] | Unset = UNSET
    incident_feedbacks_permissions: list[UpdateRoleDataAttributesIncidentFeedbacksPermissionsItem] | Unset = UNSET
    incident_roles_permissions: list[UpdateRoleDataAttributesIncidentRolesPermissionsItem] | Unset = UNSET
    incident_types_permissions: list[UpdateRoleDataAttributesIncidentTypesPermissionsItem] | Unset = UNSET
    incidents_permissions: list[UpdateRoleDataAttributesIncidentsPermissionsItem] | Unset = UNSET
    integrations_permissions: list[UpdateRoleDataAttributesIntegrationsPermissionsItem] | Unset = UNSET
    invitations_permissions: list[UpdateRoleDataAttributesInvitationsPermissionsItem] | Unset = UNSET
    playbooks_permissions: list[UpdateRoleDataAttributesPlaybooksPermissionsItem] | Unset = UNSET
    private_incidents_permissions: list[UpdateRoleDataAttributesPrivateIncidentsPermissionsItem] | Unset = UNSET
    retrospective_permissions: list[UpdateRoleDataAttributesRetrospectivePermissionsItem] | Unset = UNSET
    roles_permissions: list[UpdateRoleDataAttributesRolesPermissionsItem] | Unset = UNSET
    secrets_permissions: list[UpdateRoleDataAttributesSecretsPermissionsItem] | Unset = UNSET
    services_permissions: list[UpdateRoleDataAttributesServicesPermissionsItem] | Unset = UNSET
    severities_permissions: list[UpdateRoleDataAttributesSeveritiesPermissionsItem] | Unset = UNSET
    status_pages_permissions: list[UpdateRoleDataAttributesStatusPagesPermissionsItem] | Unset = UNSET
    webhooks_permissions: list[UpdateRoleDataAttributesWebhooksPermissionsItem] | Unset = UNSET
    workflows_permissions: list[UpdateRoleDataAttributesWorkflowsPermissionsItem] | Unset = UNSET
    catalogs_permissions: list[UpdateRoleDataAttributesCatalogsPermissionsItem] | Unset = UNSET
    sub_statuses_permissions: list[UpdateRoleDataAttributesSubStatusesPermissionsItem] | Unset = UNSET
    edge_connector_permissions: list[UpdateRoleDataAttributesEdgeConnectorPermissionsItem] | Unset = UNSET
    slas_permissions: list[UpdateRoleDataAttributesSlasPermissionsItem] | Unset = UNSET
    paging_permissions: list[UpdateRoleDataAttributesPagingPermissionsItem] | Unset = UNSET
    incident_communication_permissions: list[UpdateRoleDataAttributesIncidentCommunicationPermissionsItem] | Unset = (
        UNSET
    )
    communication_permissions: list[UpdateRoleDataAttributesCommunicationPermissionsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _private_incidents_permissions is not UNSET:
            ...
            for private_incidents_permissions_item_data in _private_incidents_permissions:
                private_incidents_permissions_item = (
                    check_update_role_data_attributes_private_incidents_permissions_item(
        ...
        if _catalogs_permissions is not UNSET:
            ...
            for catalogs_permissions_item_data in _catalogs_permissions:
                catalogs_permissions_item = check_update_role_data_attributes_catalogs_permissions_item(
        ...
        if _sub_statuses_permissions is not UNSET:
            ...
            for sub_statuses_permissions_item_data in _sub_statuses_permissions:
                sub_statuses_permissions_item = check_update_role_data_attributes_sub_statuses_permissions_item(
        ...
        if _edge_connector_permissions is not UNSET:
            ...
            for edge_connector_permissions_item_data in _edge_connector_permissions:
                edge_connector_permissions_item = check_update_role_data_attributes_edge_connector_permissions_item(
        ...
        if _slas_permissions is not UNSET:
            ...
            for slas_permissions_item_data in _slas_permissions:
                slas_permissions_item = check_update_role_data_attributes_slas_permissions_item(
                    slas_permissions_item_data
                )
        ...
        if _paging_permissions is not UNSET:
            ...
            for paging_permissions_item_data in _paging_permissions:
                paging_permissions_item = check_update_role_data_attributes_paging_permissions_item(
        ...
        incident_communication_permissions: (
            list[UpdateRoleDataAttributesIncidentCommunicationPermissionsItem] | Unset
        ) = UNSET
        ...
        if _communication_permissions is not UNSET:
            ...
            for communication_permissions_item_data in _communication_permissions:
                communication_permissions_item = check_update_role_data_attributes_communication_permissions_item(
