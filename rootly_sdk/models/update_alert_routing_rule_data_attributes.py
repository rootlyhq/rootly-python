...
class UpdateAlertRoutingRuleDataAttributes:
    ...
    Attributes:
        ...
        alerts_source_id (UUID | Unset): The ID of the alerts source
        position (int | Unset): The position of the alert routing rule for ordering evaluation
        owning_team_ids (list[UUID] | Unset): The IDs of the teams that own the alert routing rule
        condition_type (UpdateAlertRoutingRuleDataAttributesConditionType | Unset): The type of condition for the alert
            routing rule
        conditions (list[UpdateAlertRoutingRuleDataAttributesConditionsItem] | Unset):
        destination (UpdateAlertRoutingRuleDataAttributesDestination | Unset):
    """

    name: str | Unset = UNSET
    enabled: bool | Unset = UNSET
    alerts_source_id: UUID | Unset = UNSET
    position: int | Unset = UNSET
    owning_team_ids: list[UUID] | Unset = UNSET
    condition_type: UpdateAlertRoutingRuleDataAttributesConditionType | Unset = UNSET
    conditions: list[UpdateAlertRoutingRuleDataAttributesConditionsItem] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        alerts_source_id: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        condition_type: UpdateAlertRoutingRuleDataAttributesConditionType | Unset
