...
T = TypeVar("T", bound="NewIncidentTypeDataAttributesFieldsItem")


@_attrs_define
class NewIncidentTypeDataAttributesFieldsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        new_incident_type_data_attributes_fields_item = cls(
            catalog_field_id=catalog_field_id,
            value=value,
        )

        new_incident_type_data_attributes_fields_item.additional_properties = d
