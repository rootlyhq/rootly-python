...
T = TypeVar("T", bound="NewEnvironmentDataAttributesFieldsItem")


@_attrs_define
class NewEnvironmentDataAttributesFieldsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        new_environment_data_attributes_fields_item = cls(
            catalog_field_id=catalog_field_id,
            value=value,
        )

        new_environment_data_attributes_fields_item.additional_properties = d
