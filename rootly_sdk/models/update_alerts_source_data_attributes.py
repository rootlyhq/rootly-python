...
class UpdateAlertsSourceDataAttributes:
    ...
    Attributes:
        ...
        deduplication_key_kind (UpdateAlertsSourceDataAttributesDeduplicationKeyKind | Unset): Kind of deduplication
            key.
        ...
        alert_template_attributes (None | Unset | UpdateAlertsSourceDataAttributesAlertTemplateAttributesType0):
        alert_source_urgency_rules_attributes
            (list[UpdateAlertsSourceDataAttributesAlertSourceUrgencyRulesAttributesItem] | Unset): List of rules that define
            the conditions under which the alert urgency will be set automatically based on the alert payload
        sourceable_attributes (None | Unset | UpdateAlertsSourceDataAttributesSourceableAttributesType0): Provide
            additional attributes for generic_webhook alerts source
        resolution_rule_attributes (None | Unset | UpdateAlertsSourceDataAttributesResolutionRuleAttributesType0):
            Provide additional attributes for email alerts source
        alert_source_fields_attributes (list[UpdateAlertsSourceDataAttributesAlertSourceFieldsAttributesItem] | Unset):
    ...
    deduplication_key_kind: UpdateAlertsSourceDataAttributesDeduplicationKeyKind | Unset = UNSET
    ...
    alert_template_attributes: None | Unset | UpdateAlertsSourceDataAttributesAlertTemplateAttributesType0 = UNSET
    alert_source_urgency_rules_attributes: (
        list[UpdateAlertsSourceDataAttributesAlertSourceUrgencyRulesAttributesItem] | Unset
    ) = UNSET
    sourceable_attributes: None | Unset | UpdateAlertsSourceDataAttributesSourceableAttributesType0 = UNSET
    resolution_rule_attributes: None | Unset | UpdateAlertsSourceDataAttributesResolutionRuleAttributesType0 = UNSET
    alert_source_fields_attributes: list[UpdateAlertsSourceDataAttributesAlertSourceFieldsAttributesItem] | Unset = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        deduplication_key_kind: UpdateAlertsSourceDataAttributesDeduplicationKeyKind | Unset
        ...
        def _parse_alert_template_attributes(
            data: object,
        ) -> None | Unset | UpdateAlertsSourceDataAttributesAlertTemplateAttributesType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(None | Unset | UpdateAlertsSourceDataAttributesAlertTemplateAttributesType0, data)
        ...
        def _parse_sourceable_attributes(
            data: object,
        ) -> None | Unset | UpdateAlertsSourceDataAttributesSourceableAttributesType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(None | Unset | UpdateAlertsSourceDataAttributesSourceableAttributesType0, data)
        ...
        def _parse_resolution_rule_attributes(
            ...
            try:
                ...
                pass
            return cast(None | Unset | UpdateAlertsSourceDataAttributesResolutionRuleAttributesType0, data)
        ...
        alert_source_fields_attributes: (
            list[UpdateAlertsSourceDataAttributesAlertSourceFieldsAttributesItem] | Unset
        ) = UNSET
