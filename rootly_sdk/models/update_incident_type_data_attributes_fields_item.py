...
T = TypeVar("T", bound="UpdateIncidentTypeDataAttributesFieldsItem")
...
class UpdateIncidentTypeDataAttributesFieldsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_incident_type_data_attributes_fields_item = cls(
            catalog_field_id=catalog_field_id,
            value=value,
        )

        update_incident_type_data_attributes_fields_item.additional_properties = d
        return update_incident_type_data_attributes_fields_item
