...
T = TypeVar("T", bound="FunctionalityFieldsType0Item")


@_attrs_define
class FunctionalityFieldsType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        functionality_fields_type_0_item = cls(
            catalog_field_id=catalog_field_id,
            value=value,
        )

        functionality_fields_type_0_item.additional_properties = d
        return functionality_fields_type_0_item
