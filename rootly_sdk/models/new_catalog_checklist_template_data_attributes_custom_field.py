...
@_attrs_define
class NewCatalogChecklistTemplateDataAttributesCustomField:
    """
    Attributes:
        field_source (NewCatalogChecklistTemplateDataAttributesCustomFieldFieldSource):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        field_source = check_new_catalog_checklist_template_data_attributes_custom_field_field_source(
            d.pop("field_source")
        )
        ...
        new_catalog_checklist_template_data_attributes_custom_field = cls(
            field_source=field_source,
            catalog_property_id=catalog_property_id,
            field_key=field_key,
        )

        new_catalog_checklist_template_data_attributes_custom_field.additional_properties = d
