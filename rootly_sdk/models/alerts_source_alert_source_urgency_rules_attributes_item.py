...
class AlertsSourceAlertSourceUrgencyRulesAttributesItem:
    ...
    Attributes:
        json_path (None | str | Unset): JSON path expression to extract a specific value from the alert's payload for
            evaluation
        operator (AlertsSourceAlertSourceUrgencyRulesAttributesItemOperator | Unset): Comparison operator used to
        ...
        value (str | Unset): Value that the extracted payload data is compared to using the specified operator to
            determine a match
        conditionable_type (AlertsSourceAlertSourceUrgencyRulesAttributesItemConditionableType | Unset): The type of the
            conditionable
        ...
        kind (AlertsSourceAlertSourceUrgencyRulesAttributesItemKind | Unset): The kind of the conditionable
        alert_urgency_id (str | Unset): The ID of the alert urgency
    """

    json_path: None | str | Unset = UNSET
    operator: AlertsSourceAlertSourceUrgencyRulesAttributesItemOperator | Unset = UNSET
    value: str | Unset = UNSET
    conditionable_type: AlertsSourceAlertSourceUrgencyRulesAttributesItemConditionableType | Unset = UNSET
    conditionable_id: None | str | Unset = UNSET
    kind: AlertsSourceAlertSourceUrgencyRulesAttributesItemKind | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        operator: AlertsSourceAlertSourceUrgencyRulesAttributesItemOperator | Unset
        ...
        conditionable_type: AlertsSourceAlertSourceUrgencyRulesAttributesItemConditionableType | Unset
        ...
        kind: AlertsSourceAlertSourceUrgencyRulesAttributesItemKind | Unset
