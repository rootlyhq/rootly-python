...
T = TypeVar("T", bound="UpdateEnvironmentDataAttributesPropertiesItem")


@_attrs_define
class UpdateEnvironmentDataAttributesPropertiesItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_environment_data_attributes_properties_item = cls(
            catalog_property_id=catalog_property_id,
            value=value,
        )

        update_environment_data_attributes_properties_item.additional_properties = d
