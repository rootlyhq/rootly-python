...
class GetAlertsTaskParams:
    ...
    Attributes:
        past_duration (str): How far back to fetch commits (in format '1 minute', '30 days', '3 months', etc.) Example:
            1 hour.
        task_type (GetAlertsTaskParamsTaskType | Unset):
        ...
        post_to_slack_channels (list[GetAlertsTaskParamsPostToSlackChannelsItem] | Unset):
        parent_message_thread_task (GetAlertsTaskParamsParentMessageThreadTask | Unset): A hash where [id] is the task
            id of the parent task that sent a message, and [name] is the name of the parent task
    """

    past_duration: str
    task_type: GetAlertsTaskParamsTaskType | Unset = UNSET
    ...
    post_to_slack_channels: list[GetAlertsTaskParamsPostToSlackChannelsItem] | Unset = UNSET
    parent_message_thread_task: GetAlertsTaskParamsParentMessageThreadTask | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parent_message_thread_task: GetAlertsTaskParamsParentMessageThreadTask | Unset
