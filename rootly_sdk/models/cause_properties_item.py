...
T = TypeVar("T", bound="CausePropertiesItem")


@_attrs_define
class CausePropertiesItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cause_properties_item = cls(
            catalog_property_id=catalog_property_id,
            value=value,
        )

        cause_properties_item.additional_properties = d
        return cause_properties_item
