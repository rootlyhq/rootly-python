...
class Team:
    ...
    fields: None | Unset | list["TeamFieldsType0Item"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_fields(data: object) -> None | Unset | list["TeamFieldsType0Item"]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(None | Unset | list["TeamFieldsType0Item"], data)
