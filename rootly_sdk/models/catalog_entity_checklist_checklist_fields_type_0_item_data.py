...
from ..models.catalog_entity_checklist_checklist_fields_type_0_item_data_type import (
...
if TYPE_CHECKING:
    from ..models.catalog_entity_checklist_checklist_fields_type_0_item_data_attributes import (
        CatalogEntityChecklistChecklistFieldsType0ItemDataAttributes,
    )


T = TypeVar("T", bound="CatalogEntityChecklistChecklistFieldsType0ItemData")
...
class CatalogEntityChecklistChecklistFieldsType0ItemData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = CatalogEntityChecklistChecklistFieldsType0ItemDataAttributes.from_dict(_attributes)

        catalog_entity_checklist_checklist_fields_type_0_item_data = cls(
            id=id,
            type_=type_,
            attributes=attributes,
        )

        catalog_entity_checklist_checklist_fields_type_0_item_data.additional_properties = d
