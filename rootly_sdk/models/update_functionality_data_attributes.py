...
if TYPE_CHECKING:
    from ..models.update_functionality_data_attributes_properties_item import (
        UpdateFunctionalityDataAttributesPropertiesItem,
    )
...
class UpdateFunctionalityDataAttributes:
    """
    Attributes:
        name (str | Unset): The name of the functionality
        ...
        notify_emails (list[str] | None | Unset): Emails to attach to the functionality
        ...
        slack_channels (list[UpdateFunctionalityDataAttributesSlackChannelsType0Item] | None | Unset): Slack Channels
            associated with this functionality
        slack_aliases (list[UpdateFunctionalityDataAttributesSlackAliasesType0Item] | None | Unset): Slack Aliases
            associated with this functionality
        properties (list[UpdateFunctionalityDataAttributesPropertiesItem] | Unset): Array of property values for this
            functionality.
    """
    ...
    slack_channels: list[UpdateFunctionalityDataAttributesSlackChannelsType0Item] | None | Unset = UNSET
    slack_aliases: list[UpdateFunctionalityDataAttributesSlackAliasesType0Item] | None | Unset = UNSET
    properties: list[UpdateFunctionalityDataAttributesPropertiesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_slack_channels(
            data: object,
        ) -> list[UpdateFunctionalityDataAttributesSlackChannelsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(list[UpdateFunctionalityDataAttributesSlackChannelsType0Item] | None | Unset, data)

        slack_channels = _parse_slack_channels(d.pop("slack_channels", UNSET))

        def _parse_slack_aliases(
            data: object,
        ) -> list[UpdateFunctionalityDataAttributesSlackAliasesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(list[UpdateFunctionalityDataAttributesSlackAliasesType0Item] | None | Unset, data)
        ...
        if _properties is not UNSET:
            ...
            for properties_item_data in _properties:
                properties_item = UpdateFunctionalityDataAttributesPropertiesItem.from_dict(properties_item_data)
