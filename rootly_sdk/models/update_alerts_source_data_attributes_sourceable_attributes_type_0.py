...
class UpdateAlertsSourceDataAttributesSourceableAttributesType0:
    ...
    Attributes:
        ...
        field_mappings_attributes
            (list[UpdateAlertsSourceDataAttributesSourceableAttributesType0FieldMappingsAttributesItem] | Unset): Specify
            rules to auto resolve alerts
    """
    ...
    field_mappings_attributes: (
        list[UpdateAlertsSourceDataAttributesSourceableAttributesType0FieldMappingsAttributesItem] | Unset
    ) = UNSET
