...
T = TypeVar("T", bound="ShiftRelationshipsAssignee")


@_attrs_define
class ShiftRelationshipsAssignee:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        shift_relationships_assignee = cls(
            data=data,
        )

        shift_relationships_assignee.additional_properties = d
        return shift_relationships_assignee
