...
T = TypeVar("T", bound="EnvironmentFieldsType0Item")


@_attrs_define
class EnvironmentFieldsType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        environment_fields_type_0_item = cls(
            catalog_field_id=catalog_field_id,
            value=value,
        )

        environment_fields_type_0_item.additional_properties = d
        return environment_fields_type_0_item
