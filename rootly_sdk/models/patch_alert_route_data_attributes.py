...
class PatchAlertRouteDataAttributes:
    """
    Attributes:
        name (str | Unset): The name of the alert route
        enabled (bool | Unset): Whether the alert route is enabled
        alerts_source_ids (list[UUID] | Unset):
        owning_team_ids (list[UUID] | Unset):
        rules (list[PatchAlertRouteDataAttributesRulesItem] | Unset):
    """

    name: str | Unset = UNSET
    enabled: bool | Unset = UNSET
    alerts_source_ids: list[UUID] | Unset = UNSET
    owning_team_ids: list[UUID] | Unset = UNSET
    rules: list[PatchAlertRouteDataAttributesRulesItem] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        alerts_source_ids: list[str] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        alerts_source_ids: list[UUID] | Unset = UNSET
        if _alerts_source_ids is not UNSET:
            alerts_source_ids = []
