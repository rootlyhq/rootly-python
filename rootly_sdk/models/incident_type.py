...
class IncidentType:
    ...
    Attributes:
        ...
        slug (str | Unset): The slug of the incident type
        ...
        slack_channels (list[IncidentTypeSlackChannelsType0Item] | None | Unset): Slack Channels associated with this
            incident type
        slack_aliases (list[IncidentTypeSlackAliasesType0Item] | None | Unset): Slack Aliases associated with this
            incident type
        properties (list[IncidentTypePropertiesItem] | Unset): Array of property values for this incident type.
    """
    ...
    slack_channels: list[IncidentTypeSlackChannelsType0Item] | None | Unset = UNSET
    slack_aliases: list[IncidentTypeSlackAliasesType0Item] | None | Unset = UNSET
    properties: list[IncidentTypePropertiesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_slack_channels(data: object) -> list[IncidentTypeSlackChannelsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(list[IncidentTypeSlackChannelsType0Item] | None | Unset, data)

        slack_channels = _parse_slack_channels(d.pop("slack_channels", UNSET))

        def _parse_slack_aliases(data: object) -> list[IncidentTypeSlackAliasesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(list[IncidentTypeSlackAliasesType0Item] | None | Unset, data)
        ...
        if _properties is not UNSET:
            ...
            for properties_item_data in _properties:
                properties_item = IncidentTypePropertiesItem.from_dict(properties_item_data)
