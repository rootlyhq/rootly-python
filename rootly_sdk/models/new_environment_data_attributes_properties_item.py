...
T = TypeVar("T", bound="NewEnvironmentDataAttributesPropertiesItem")


@_attrs_define
class NewEnvironmentDataAttributesPropertiesItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        new_environment_data_attributes_properties_item = cls(
            catalog_property_id=catalog_property_id,
            value=value,
        )

        new_environment_data_attributes_properties_item.additional_properties = d
