...
class UpdateServiceNowIncidentTaskParams:
    ...
    Attributes:
        ...
        task_type (UpdateServiceNowIncidentTaskParamsTaskType | Unset):
        title (str | Unset): The incident title
        description (str | Unset): The incident description
        priority (UpdateServiceNowIncidentTaskParamsPriority | Unset): The priority id and display name
        completion (UpdateServiceNowIncidentTaskParamsCompletion | Unset): The completion id and display name
        custom_fields_mapping (None | str | Unset): Custom field mappings. Can contain liquid markup and need to be
            valid JSON
    """

    incident_id: str
    task_type: UpdateServiceNowIncidentTaskParamsTaskType | Unset = UNSET
    title: str | Unset = UNSET
    description: str | Unset = UNSET
    priority: UpdateServiceNowIncidentTaskParamsPriority | Unset = UNSET
    completion: UpdateServiceNowIncidentTaskParamsCompletion | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        priority: UpdateServiceNowIncidentTaskParamsPriority | Unset
        ...
        completion: UpdateServiceNowIncidentTaskParamsCompletion | Unset
