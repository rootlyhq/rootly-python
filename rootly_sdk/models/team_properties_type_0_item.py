...
T = TypeVar("T", bound="TeamPropertiesType0Item")


@_attrs_define
class TeamPropertiesType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        team_properties_type_0_item = cls(
            catalog_property_id=catalog_property_id,
            value=value,
        )

        team_properties_type_0_item.additional_properties = d
        return team_properties_type_0_item
