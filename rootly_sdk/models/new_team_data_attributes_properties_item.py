...
T = TypeVar("T", bound="NewTeamDataAttributesPropertiesItem")


@_attrs_define
class NewTeamDataAttributesPropertiesItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        new_team_data_attributes_properties_item = cls(
            catalog_property_id=catalog_property_id,
            value=value,
        )

        new_team_data_attributes_properties_item.additional_properties = d
