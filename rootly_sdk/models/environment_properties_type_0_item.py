...
T = TypeVar("T", bound="EnvironmentPropertiesType0Item")


@_attrs_define
class EnvironmentPropertiesType0Item:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        environment_properties_type_0_item = cls(
            catalog_property_id=catalog_property_id,
            value=value,
        )

        environment_properties_type_0_item.additional_properties = d
        return environment_properties_type_0_item
