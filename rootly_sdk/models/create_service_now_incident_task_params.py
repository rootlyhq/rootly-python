...
class CreateServiceNowIncidentTaskParams:
    ...
    Attributes:
        ...
        task_type (CreateServiceNowIncidentTaskParamsTaskType | Unset):
        description (str | Unset): The incident description
        priority (CreateServiceNowIncidentTaskParamsPriority | Unset): The priority id and display name
        completion (CreateServiceNowIncidentTaskParamsCompletion | Unset): The completion id and display name
        custom_fields_mapping (None | str | Unset): Custom field mappings. Can contain liquid markup and need to be
            valid JSON
    """

    title: str
    task_type: CreateServiceNowIncidentTaskParamsTaskType | Unset = UNSET
    description: str | Unset = UNSET
    priority: CreateServiceNowIncidentTaskParamsPriority | Unset = UNSET
    completion: CreateServiceNowIncidentTaskParamsCompletion | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        priority: CreateServiceNowIncidentTaskParamsPriority | Unset
        ...
        completion: CreateServiceNowIncidentTaskParamsCompletion | Unset
