...
T = TypeVar("T", bound="IncidentTypeFieldsItem")


@_attrs_define
class IncidentTypeFieldsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        incident_type_fields_item = cls(
            catalog_field_id=catalog_field_id,
            value=value,
        )

        incident_type_fields_item.additional_properties = d
        return incident_type_fields_item
