...
T = TypeVar("T", bound="EscalationPolicyPathRulesItemType7Type5TimeBlocksItem")
...
class EscalationPolicyPathRulesItemType7Type5TimeBlocksItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        escalation_policy_path_rules_item_type_7_type_5_time_blocks_item = cls(
            monday=monday,
            tuesday=tuesday,
            wednesday=wednesday,
            thursday=thursday,
        ...
        escalation_policy_path_rules_item_type_7_type_5_time_blocks_item.additional_properties = d
