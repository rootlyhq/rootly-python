...
class UpdateAlertRouteDataAttributesRulesItemConditionGroupsItemConditionsItem:
    ...
    Attributes:
        ...
        conditionable_type (UpdateAlertRouteDataAttributesRulesItemConditionGroupsItemConditionsItemConditionableType |
    ...
    conditionable_type: (
        UpdateAlertRouteDataAttributesRulesItemConditionGroupsItemConditionsItemConditionableType | Unset
    ) = UNSET
