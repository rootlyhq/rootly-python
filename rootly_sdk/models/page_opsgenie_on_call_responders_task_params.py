...
class PageOpsgenieOnCallRespondersTaskParams:
    """
    Attributes:
        task_type (PageOpsgenieOnCallRespondersTaskParamsTaskType | Unset):
        ...
        teams (list[PageOpsgenieOnCallRespondersTaskParamsTeamsItem] | Unset):
        users (list[PageOpsgenieOnCallRespondersTaskParamsUsersItem] | Unset):
        priority (PageOpsgenieOnCallRespondersTaskParamsPriority | Unset):  Default: 'P1'.
    """

    task_type: PageOpsgenieOnCallRespondersTaskParamsTaskType | Unset = UNSET
    title: None | str | Unset = UNSET
    message: str | Unset = UNSET
    description: str | Unset = UNSET
    teams: list[PageOpsgenieOnCallRespondersTaskParamsTeamsItem] | Unset = UNSET
    users: list[PageOpsgenieOnCallRespondersTaskParamsUsersItem] | Unset = UNSET
    priority: PageOpsgenieOnCallRespondersTaskParamsPriority | Unset = "P1"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        priority: PageOpsgenieOnCallRespondersTaskParamsPriority | Unset
