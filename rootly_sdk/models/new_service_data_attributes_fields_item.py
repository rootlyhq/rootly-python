...
T = TypeVar("T", bound="NewServiceDataAttributesFieldsItem")


@_attrs_define
class NewServiceDataAttributesFieldsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        new_service_data_attributes_fields_item = cls(
            catalog_field_id=catalog_field_id,
            value=value,
        )

        new_service_data_attributes_fields_item.additional_properties = d
