...
T = TypeVar("T", bound="EscalationPolicyPathRulesItemType5TimeBlocksItem")


@_attrs_define
class EscalationPolicyPathRulesItemType5TimeBlocksItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        escalation_policy_path_rules_item_type_5_time_blocks_item = cls(
            monday=monday,
            tuesday=tuesday,
            wednesday=wednesday,
            thursday=thursday,
        ...
        escalation_policy_path_rules_item_type_5_time_blocks_item.additional_properties = d
        return escalation_policy_path_rules_item_type_5_time_blocks_item
