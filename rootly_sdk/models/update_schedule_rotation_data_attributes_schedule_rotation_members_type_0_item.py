...
@_attrs_define
class UpdateScheduleRotationDataAttributesScheduleRotationMembersType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        member_type = check_update_schedule_rotation_data_attributes_schedule_rotation_members_type_0_item_member_type(
            d.pop("member_type")
        )
        ...
        update_schedule_rotation_data_attributes_schedule_rotation_members_type_0_item = cls(
            member_type=member_type,
            member_id=member_id,
            position=position,
        )
