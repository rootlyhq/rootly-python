...
@_attrs_define
class UpdateQuipPageTaskParams:
    """
    Attributes:
    ...
    file_id: str
    task_type: Union[Unset, UpdateQuipPageTaskParamsTaskType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_task_type, Unset):
            ...
            task_type = check_update_quip_page_task_params_task_type(_task_type)
        ...
        update_quip_page_task_params = cls(
            file_id=file_id,
            task_type=task_type,
            title=title,
            content=content,
        ...
        update_quip_page_task_params.additional_properties = d
        return update_quip_page_task_params
